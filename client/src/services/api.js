...
const API_URL = process.env.REACT_APP_API_URL || 'http://192.168.100.232:5000/api';
...
const UPLOADS_URL = process.env.REACT_APP_UPLOADS_URL || 'http://192.168.100.232:5000/uploads';
